...
public class Program {
	...
	public static void main(String[] args) {
		...
		LocalDate d08 = LocalDate.parse("18/02/2023", fmt1);
		LocalDateTime d09 = LocalDateTime.parse("18/02/2023 13:00", fmt2);
		
		LocalDate d10 = LocalDate.of(2023, 2, 18);
		LocalDateTime d11 = LocalDateTime.of(2023, 2, 18, 1, 30);
